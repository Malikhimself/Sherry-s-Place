...
export default function AddProductPage() {
    return (
        <div className="container mx-auto px-4 py-12 max-w-2xl">
            ...
            <h1 className="text-3xl font-bold mb-8 text-primary-green">Add New Product</h1>

            <form action={createProductAction} className="bg-white rounded-xl shadow-sm border border-primary-green/5 p-8 space-y-6">
                <div>
                    ...
                    <input
                        ...
                        placeholder="e.g. Copper Saucepan"
                    />
                </div>
